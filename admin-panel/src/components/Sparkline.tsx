 ...
 *
 * DELIBERATELY NOT RECHARTS. This console already pays for recharts on the
 * Dashboard, Analytics and Revenue charts; a sparkline needs a path and an area
 * under it, and rendering one through a charting library costs a
 * ResponsiveContainer, a resize observer and a render pass per tile to draw
 * twelve line segments. This is one `<svg>` and a string.
 *
 ...
 *
 * Ported unchanged from client-panel/src/components/Sparkline.tsx — including
 * the emerald ink, which is the one hue that may carry "money arrived". A
 * sparkline under a revenue figure is money arriving over time; under anything
 * that is not money, pass nothing and use a real chart.
 */
